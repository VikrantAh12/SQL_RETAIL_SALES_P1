...
--Q.2 Write a SQL query to retrieve all transcation where the category is 'Clothing' and the quantity sold is more than 4 on the month of Nov-2022
SELECT *
FROM retail_sales
...
--Q.4  Write a SQL query to find the average age of customers who purchased itmes from the 'Beauty' category
SELECT ROUND(AVG(age),2)  as avg_age 
FROM retail_sales
WHERE category='Beauty'

--Q.5  Write a SQL query to find all transcation where the toatal_sales is greater than 1000

SELECT* FROM retail_sales
WHERE total_sale> 1000

--Q.6  Write a SQL query to find the total number of transcation (transcation_id) made by each gender in each category
